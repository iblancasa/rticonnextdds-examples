...
void dropListener_on_data_available(void *listener_data, DDS_DataReader *reader)
{
    ...
    for (i = 0; i < dropSeq_get_length(&data_seq); ++i) {
        if (DDS_SampleInfoSeq_get_reference(&info_seq, i)->valid_data) {
            ...
            dropTypeSupport_print_data(dropSeq_get_reference(&data_seq, i));
        }
    }

    retcode = dropDataReader_return_loan(drop_reader, &data_seq, &info_seq);
...
int subscriber_main(int domainId, int sample_count)
{
    ...
    reader_listener.on_sample_rejected = dropListener_on_sample_rejected;
    reader_listener.on_liveliness_changed = dropListener_on_liveliness_changed;
    reader_listener.on_sample_lost = dropListener_on_sample_lost;
    reader_listener.on_subscription_matched =
            dropListener_on_subscription_matched;
    reader_listener.on_data_available = dropListener_on_data_available;
